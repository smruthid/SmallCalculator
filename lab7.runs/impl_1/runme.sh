...
HD_PWD='C:/Vivado/lab7/lab7.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cudp_FPGA.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cudp_FPGA.tcl -notrace
